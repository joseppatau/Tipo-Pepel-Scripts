                        ...
                        for rightKey, value in rightDict.items():
                            ...
                            if self._isUpperCase(font, leftKey) and self._isLowerCase(font, rightKey):
                                ...
                                if rightKey.startswith("@MMK_R_"):
                                    ...
                                    if debug_mode and total_seen <= debug_liApache2_shown:
