# Assign Metrics to Small Caps in all masters

A GlyphsApp utility for assign metrics to small caps in all masters.
...
3. Run **Assign Metrics to Small Caps in all masters** from the Scripts menu.
