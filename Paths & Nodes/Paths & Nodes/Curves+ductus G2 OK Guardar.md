# Fit Curve & Ductus PRO (Slope Lock + Green Harmony G2)

A GlyphsApp utility for fit curve & ductus pro.
...
3. Run **Fit Curve & Ductus PRO (Slope Lock + Green Harmony G2)** from the Scripts menu.
